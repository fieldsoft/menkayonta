...
let
  nixifiedLockHash = "0f9ec34797166cebfcaa6644283cb5aca0a0ec2383a26f69d853e9368a321660";
...
in
{
  ...
  workspace = {
    menkayonta = rustPackages.unknown.menkayonta."0.1.0";
  };
  "unknown".menkayonta."0.1.0" = overridableMkRustCrate (profileName: rec {
    name = "menkayonta";
    version = "0.1.0";
    registry = "unknown";
