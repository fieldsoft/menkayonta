...
Menkayonta means \"workbook\" in Wao Terero, a linguistic isolate
spoken in the Ecuadorian Amazon.
...
Some have noted that it is a bit of a long name. In this world of
bland marketing speak, I find it refreshing to have a word with some
meat to it used for a computer program.
...
1.  Reproduce and improve the important functionality of
    ...
    Menkayonta.
    - [x] Provide a data entry and search interface for glossed linguistic
        data from elicitation.
    - [x] Allow data that is entered in the database to be shared with
        other researchers.
...
2.  Provide a collaborative notes and agenda environment.
    - [x] A rich markup language (Markdown).
    - [ ] Task items.
    - [ ] Agenda view to plan work or study.
    - [ ] The ability to export reports, portions of technical papers,
        lesson plans, etc.
    - [ ] Programming notebook-like functionality to allow
        advanced users to run sandboxed scripts.
3.  Offline first functionality
    - [x] No central server is needed for a private database
    - [x] Users may synchronize local databases with a shared central
        database
...
7.  The ability to define and run elicitation protocols
    ...
    - [ ] Questionnaires that follow flow-chart patterns.
    - [ ] A separate app can run the protocols on mobile devices and
        synchronize responses with the user's menkayonta instance.
...
1.  Advantages of PouchDB over alternatives
    ...
    -   Mature
        ...
        -   Recent development funded by the German [Sovereign Tech
            Agency](https://www.sovereign.tech/), indicative of its
            essential role in sovereign IT infrastructure.
    -   Fully open source
